	...
	<div id="wrapper">
		<div id="header">
			<div id="logo">
				<br />
				<h1>
					<a href="#"><img src="images/city1.jpg" width="180" /></a>
				</h1>
			</div>
		</div>
		<!-- end #header -->
		...
		<div id="welcome">
			...
			<div class="entry">
				...
				city.JAVATPOINT.COM aims not only providing tutorial classes of java
				but also java PROJECT FREE....
			</div>
		...
		<div id="page">
			...
			<div id="sidebar">
				<ul>
					<li>
						<h2>
							<marquee>Free advertisement..</marquee>
						</h2>
						<ul>
