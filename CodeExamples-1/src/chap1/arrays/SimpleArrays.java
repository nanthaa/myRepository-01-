...
public class SimpleArrays
{
	...
	public static void main(String[] argv)
	{
		...
		// infinitive loop
		// for (System.out.println("any operator here2") ; true;
		// System.out.println("any operator here"));

		int arr40[];
		// System.out.println( "int arr40 [] = {} :" + arr40.length); //The
		// local variable arr40 may not have been initialized
